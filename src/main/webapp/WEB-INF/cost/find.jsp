...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <!-- 
        	对于浏览器而言，资费查询的页面的路径是/netctoss/findCost.do
        	而当前页面所引用的样式文件和图片是目标，其路径是/netctoss/styles/global.css
         -->
        ...
        <script language="javascript" type="text/javascript">
            ...
            function deleteCost(id) {
                var d = window.confirm("确定要删除此资费吗？");
                if(d) {
                ...
                <div id="data">            
                    <table id="datalist">
                        ...
                        <tr>
                            ...
                            <td>                                
                                <input type="button" value="启用" class="btn_start" onclick="startCost(id=${c.costId });" />
                                <input type="button" value="修改" class="btn_modify" onclick="location.href='toUpdateCost.do?id=${c.costId }';" />
                                <input type="button" value="删除" class="btn_delete" onclick="deleteCost(${c.costId });" />
                            </td>
                        </tr>
                        </c:forEach>
                    </table>
